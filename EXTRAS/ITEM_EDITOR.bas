print "hello!"
print "this is the item manager!"
print "this is where you edit item variables!"
print "thats all really,so good luck!"
fileName$=""'self explanatory
INPUT "CHOOSE NAME FOR FILE:";fileName$
print "your file name will be: ";chr$(34);fileName$;chr$(34)
REM working loop
do
    print "Choose action:"
